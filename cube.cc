...
_cube::_cube(float Size)
{
    ...
    Triangles[0]=_vertex3ui(4,1,0);
    Triangles[1]=_vertex3ui(1,4,5);
    Triangles[2]=_vertex3ui(5,2,1);
    Triangles[3]=_vertex3ui(2,5,6);
    Triangles[4]=_vertex3ui(7,2,6);
    Triangles[5]=_vertex3ui(2,7,3);
    Triangles[6]=_vertex3ui(0,7,4);
    Triangles[7]=_vertex3ui(7,0,3);
    Triangles[8]=_vertex3ui(5,7,6);
    Triangles[9]=_vertex3ui(7,5,4);
    Triangles[10]=_vertex3ui(3,1,2);
    Triangles[11]=_vertex3ui(1,3,0);
